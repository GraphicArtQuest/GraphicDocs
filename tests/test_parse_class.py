...
class TestParseClass(unittest.TestCase):
    ...
    def test_simple_class_with_nested_subclasses_and_inheritence(self):
        ...
        expected_parsed_function_return["subclasses"]["SubClass3"]["lineno"] = parsed_return_dict["subclasses"]["SubClass3"]["lineno"]
        expected_parsed_function_return["subclasses"]["SubClass3"]["sourcefile"] = parsed_return_dict["subclasses"]["SubClass3"]["sourcefile"]
        expected_parsed_function_return["subclasses"]["SubClass4"]["lineno"] = parsed_return_dict["subclasses"]["SubClass4"]["lineno"]
        expected_parsed_function_return["subclasses"]["SubClass4"]["sourcefile"] = parsed_return_dict["subclasses"]["SubClass4"]["sourcefile"]
        expected_parsed_function_return["subclasses"]["SubClass4"]["subclasses"]["SubClass5"]["lineno"] = parsed_return_dict["subclasses"]["SubClass4"]["subclasses"]["SubClass5"]["lineno"]
        expected_parsed_function_return["subclasses"]["SubClass4"]["subclasses"]["SubClass5"]["sourcefile"] = parsed_return_dict["subclasses"]["SubClass4"]["subclasses"]["SubClass5"]["sourcefile"]
